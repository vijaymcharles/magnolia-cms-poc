...
This package contains:
   ...
   Magnolia Core 5.4.6
   Magnolia Internationalization Framework 5.4.6
   Magnolia Imaging Support Module 3.2.6
   Magnolia JAAS 5.4.6
   Magnolia Imaging Module 3.2.6
   Magnolia Rendering 5.4.6
   Magnolia Templating 5.4.6
   Magnolia Templating for JSP 5.4.6
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.4.6.html
